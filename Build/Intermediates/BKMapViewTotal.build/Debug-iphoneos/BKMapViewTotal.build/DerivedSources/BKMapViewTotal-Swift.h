...
/// 当addAnnotation后回调这个代理方法 *根据anntation生成对应的View *@param mapView 地图View *@param annotation 指定的标注 *@return 生成的标注View
...
- (void)scrollToRightPosition:(NSInteger)index;
...
@property (nonatomic, copy) NSArray<BMKAnnotationView *> * _Nullable annotationViewArr;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
